                    ...
                    inputSchema: z.object({
                        ...
                        workoutDays: z
                            ...
                            estimatedDurationInSeconds: z
                                .number()
                                .describe("Duração estimada em segundso (0 para das de descanso)"),
                            coverImageUrl: z
                                .url()
                                .optional()
                            ...
                            exercises: z
                                ...
                                .describe("Lista de exercicios (vazia para dias de descanso)"),
                        }))
                            .describe("Array com exetamente 7 dias de treino (MONDAY to SUNDAY)"),
                    }),
                    execute: async (input) => {
